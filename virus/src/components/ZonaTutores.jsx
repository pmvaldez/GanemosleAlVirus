  ...
  <article className="episode">
    ...
    <div className="episode__content">
      ...
      <div className="story">
        ...
        <p>Sed vitae rhoncus augue. In pretium molestie nulla, ut tempor nibh mattis in. Nunc finibus ante a quam porttitor vestibulum. Nulla in libero risus. Mauris hendrerit porttitor fermentum. Donec rutrum, sapien. </p>
        <p>Maecenas placerat a lorem at molestie. Donec placerat venenatis erat. Nullam auctor magna nec dolor accumsan porta. Duis eget luctus risus. Curabitur sollicitudin nulla ac magna convallis commodo. </p>
      </div>
    </div>
  </article>
  ...
  <article className="episode">
    ...
    <div className="episode__content">
      ...
      <p>Aliquam in tellus vulputate, venenatis sapien sit amet, pharetra purus. Praesent dapibus quam sed tempor dapibus. Maecenas quis lacus sagittis, maximus massa vel. </p>
        ...
        <p>Sed vitae rhoncus augue. In pretium molestie nulla, ut tempor nibh mattis in. Nunc finibus ante a quam porttitor vestibulum. Nulla in libero risus. Mauris hendrerit porttitor fermentum. Donec rutrum, sapien. </p>
        <p>Maecenas placerat a lorem at molestie. Donec placerat venenatis erat. Nullam auctor magna nec dolor accumsan porta. Duis eget luctus risus. Curabitur sollicitudin nulla ac magna convallis commodo. </p>
       <p>Mauris tempus, orci a tincidunt dignissim, ex ante gravida purus, eu gravida odio lacus non orci. In finibus magna sit amet lectus semper facilisis.</p>
        <p>Nullam facilisis, arcu ut vulputate lacinia, justo dolor ullamcorper augue, ac dapibus erat orci id ligula. Curabitur venenatis auctor iaculis. Suspendisse potenti. Vivamus et augue ultricies, pharetra nulla pulvinar, fermentum nunc. Vestibulum nec erat. </p>
      </div>
    </div>
  </article>
</div>
